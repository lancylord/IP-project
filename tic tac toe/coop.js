...
function checkWin(playerNum) {
  //check horizontal
  for (i = 0; i < 3; i++) {if (window.CP.shouldStopExecution(0)) break;
  ...
  //check vertical
  window.CP.exitedLoop(0);for (i = 0; i < 3; i++) {if (window.CP.shouldStopExecution(1)) break;
    console.log("i is: " + i);
  ...
  //check diagonal
  window.CP.exitedLoop(1);if ((grid[0][0] == grid[1][1] && grid[1][1] == grid[2][2] || grid[0][2] == grid[1][1] && grid[1][1] == grid[2][0]) && grid[1][1] !== undefined) {
  ...
  for (var i = 0; i < 3; i++) {if (window.CP.shouldStopExecution(2)) break;
    for (var x = 0; x < 3; x++) {if (window.CP.shouldStopExecution(3)) break;
